...
static inline kk_std_core_hnd__htag kk_std_core_hnd__copy(kk_std_core_hnd__htag _this, kk_std_core_types__optional tagname0, kk_context_t* _ctx) { /* forall<a> (htag<a>, tagname : optional<string>) -> htag<a> */ 
  ...
  _match10620: ;
  return kk_std_core_hnd__new_Htag(_x10619, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd__copy_1(kk_std_core_hnd__marker _this, kk_std_core_types__optional m0, kk_context_t* _ctx) { /* forall<e,a> (marker<e,a>, m : optional<int32>) -> marker<e,a> */ 
  ...
  _match10623: ;
  return kk_std_core_hnd__new_Marker(_x10622, _ctx);
}
...
static inline kk_std_core_hnd__htag kk_std_core_hnd_htag(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> htag<a> */ 
  {
    struct kk_std_core_hnd_Ev* _con10625 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__htag _x = _con10625->htag;
...
static inline int32_t kk_std_core_hnd_cfc(kk_std_core_hnd__ev ev, kk_context_t* _ctx) { /* forall<a> (ev : ev<a>) -> cfc */ 
  {
    struct kk_std_core_hnd_Ev* _con10626 = kk_std_core_hnd__as_Ev(ev);
    int32_t _x = _con10626->cfc;
    return _x;
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : forall<e1,c> (b<e1,c>) -> clause0<a,b,e1,c>) -> e a */ 
  {
    struct kk_std_core_hnd_Ev* _con10647 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con10647->marker;
    kk_box_t h = _con10647->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause0 _match_10607 = kk_function_call(kk_std_core_hnd__clause0, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause0<3566,3568,547,548>*/;
    {
      kk_function_t f = _match_10607.clause;
...
static inline kk_box_t kk_std_core_hnd__perform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con10648 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con10648->marker;
    kk_box_t h = _con10648->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_10606 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<3670,3671,3673,569,570>*/;
    {
      kk_function_t f = _match_10606.clause;
...
static inline kk_box_t kk_std_core_hnd__perform2(kk_std_core_hnd__ev evx, kk_function_t op, kk_box_t x, kk_box_t y, kk_context_t* _ctx) { /* forall<a,b,c,e,d> (evx : ev<d>, op : forall<e1,a1> (d<e1,a1>) -> clause2<a,b,c,d,e1,a1>, x : a, y : b) -> e c */ 
  {
    struct kk_std_core_hnd_Ev* _con10649 = kk_std_core_hnd__as_Ev(evx);
    kk_std_core_hnd__marker m0 = _con10649->marker;
    kk_box_t h = _con10649->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause2 _match_10605 = kk_function_call(kk_std_core_hnd__clause2, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause2<3790,3791,3792,3794,594,595>*/;
    {
      kk_function_t f = _match_10605.clause;
...
static inline kk_box_t kk_std_core_hnd_xperform1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : forall<e1,d> (c<e1,d>) -> clause1<a,b,c,e1,d>, x : a) -> e b */ 
  {
    struct kk_std_core_hnd_Ev* _con10650 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con10650->marker;
    kk_box_t h = _con10650->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_10604 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<4055,4056,4058,698,699>*/;
    {
      kk_function_t f = _match_10604.clause;
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), f, (f, m0, ev, x, _ctx));
    }
  }
}
...
struct kk_std_core_hnd_clause_tail_noyield0_fun10651__t {
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield0_fun10651(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield0_fun10651__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield0_fun10651__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield0_fun10651, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_tail_noyield0(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c> (op : () -> e b) -> clause0<b,c,e,a> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_tail_noyield0_fun10651(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield1_fun10652__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield1_fun10652(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield1_fun10652__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield1_fun10652__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield1_fun10652, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_tail_noyield1(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d> (op : (b) -> e c) -> clause1<b,c,d,e,a> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_tail_noyield1_fun10652(op, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_tail_noyield2_fun10653__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail_noyield2_fun10653(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail_noyield2_fun10653__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail_noyield2_fun10653__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail_noyield2_fun10653, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail_noyield2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail_noyield2_fun10653(op, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_value_fun10656__t {
  struct kk_function_s _base;
  kk_box_t v;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_value_fun10656(kk_box_t v, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_value_fun10656__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_value_fun10656__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_value_fun10656, kk_context());
  _self->v = v;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause0 kk_std_core_hnd_clause_value(kk_box_t v, kk_context_t* _ctx) { /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */ 
  return kk_std_core_hnd__new_Clause0(kk_std_core_hnd_new_clause_value_fun10656(v, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_resume(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e b */ 
  kk_function_t _x10658;
  kk_function_t _brw_10603 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x10658 = _brw_10603; /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/
  kk_std_core_hnd__resume_result _x10657 = kk_std_core_hnd__new_Deep(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x10658, (_x10658, _x10657, _ctx));
}
...
static inline kk_box_t kk_std_core_hnd_resume_shallow(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : a) -> e1 b */ 
  kk_function_t _x10660;
  kk_function_t _brw_10602 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x10660 = _brw_10602; /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/
  kk_std_core_hnd__resume_result _x10659 = kk_std_core_hnd__new_Shallow(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x10660, (_x10660, _x10659, _ctx));
}

static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x10661 = kk_std_core_hnd_fresh_marker_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x10661, _ctx);
}
...
static inline kk_std_core_hnd__marker kk_std_core_hnd_fresh_marker_named(kk_context_t* _ctx) { /* forall<e,a> () -> marker<e,a> */ 
  int32_t _x10693 = kk_std_core_hnd_fresh_marker_named_int(_ctx); /*int32*/
  return kk_std_core_hnd__new_Marker(_x10693, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd__perform3(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_context_t* _ctx) { /* forall<a,b,c,d,e,a1> (ev : ev<a1>, op : forall<e1,b1> (a1<e1,b1>) -> clause1<(a, b, c),d,a1,e1,b1>, x1 : a, x2 : b, x3 : c) -> e d */ 
  {
    struct kk_std_core_hnd_Ev* _con10717 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con10717->marker;
    kk_box_t h = _con10717->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_10581 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6336, 6337, 6338),6339,6341,1105,1106>*/;
    {
      kk_function_t _fun_unbox_x10382 = _match_10581.clause;
      kk_box_t _x10718;
      kk_std_core_types__tuple3_ _x10719 = kk_std_core_types__new_dash__lp__comma__comma__rp_(x1, x2, x3, _ctx); /*(13, 14, 15)*/
      _x10718 = kk_std_core_types__tuple3__box(_x10719, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10382, (_fun_unbox_x10382, m0, ev, _x10718, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd__perform4(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x1, kk_box_t x2, kk_box_t x3, kk_box_t x4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,e,b1> (ev : ev<b1>, op : forall<e1,c1> (b1<e1,c1>) -> clause1<(a, b, c, d),a1,b1,e1,c1>, x1 : a, x2 : b, x3 : c, x4 : d) -> e a1 */ 
  {
    struct kk_std_core_hnd_Ev* _con10720 = kk_std_core_hnd__as_Ev(ev);
    kk_std_core_hnd__marker m0 = _con10720->marker;
    kk_box_t h = _con10720->hnd;
    kk_box_dup(h);
    kk_std_core_hnd__clause1 _match_10580 = kk_function_call(kk_std_core_hnd__clause1, (kk_function_t, kk_box_t, kk_context_t*), op, (op, h, _ctx)); /*std/core/hnd/clause1<(6390, 6391, 6392, 6393),6394,6396,1137,1138>*/;
    {
      kk_function_t _fun_unbox_x10389 = _match_10580.clause;
      kk_box_t _x10721;
      kk_std_core_types__tuple4_ _x10722 = kk_std_core_types__new_dash__lp__comma__comma__comma__rp_(kk_reuse_null, x1, x2, x3, x4, _ctx); /*(22, 23, 24, 25)*/
      _x10721 = kk_std_core_types__tuple4__box(_x10722, _ctx); /*51*/
      return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__marker, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x10389, (_fun_unbox_x10389, m0, ev, _x10721, _ctx));
    }
  }
}
...
static inline kk_box_t kk_std_core_hnd_finalize_1(kk_std_core_hnd__resume_context r, kk_box_t x, kk_context_t* _ctx) { /* forall<a,e,e1,b> (r : resume-context<a,e,e1,b>, x : b) -> e b */ 
  kk_function_t _x10753;
  kk_function_t _brw_10572 = kk_std_core_hnd_k(r, _ctx); /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/;
  kk_std_core_hnd__resume_context_drop(r, _ctx);
  _x10753 = _brw_10572; /*(std/core/hnd/resume-result<2857,2860>) -> 2858 2860*/
  kk_std_core_hnd__resume_result _x10752 = kk_std_core_hnd__new_Finalize(x, _ctx); /*std/core/hnd/resume-result<80,81>*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_std_core_hnd__resume_result, kk_context_t*), _x10753, (_x10753, _x10752, _ctx));
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun10767__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun10767(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun10767__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun10767__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun10767, kk_context());
...
// lift anonymous function
struct kk_std_core_hnd_clause_control1_fun10768__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x;
};
extern kk_box_t kk_std_core_hnd_clause_control1_fun10768(kk_function_t _fself, kk_function_t k0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_clause_control1_fun10768(kk_function_t clause0, kk_box_t x, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control1_fun10768__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control1_fun10768__t, 3, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control1_fun10768, kk_context());
  _self->clause0 = clause0;
  _self->x = x;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause1 kk_std_core_hnd_clause_control1(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */ 
  return kk_std_core_hnd__new_Clause1(kk_std_core_hnd_new_clause_control1_fun10767(clause0, _ctx), _ctx);
}


// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun10769__t {
  struct kk_function_s _base;
  kk_function_t clause0;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun10769(kk_function_t clause0, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun10769__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun10769__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun10769, kk_context());
  _self->clause0 = clause0;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_clause_control2_fun10770__t {
  struct kk_function_s _base;
  kk_function_t clause0;
  kk_box_t x1;
  kk_box_t x2;
...
static inline kk_function_t kk_std_core_hnd_new_clause_control2_fun10770(kk_function_t clause0, kk_box_t x1, kk_box_t x2, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_control2_fun10770__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_control2_fun10770__t, 4, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_control2_fun10770, kk_context());
  _self->clause0 = clause0;
  _self->x1 = x1;
  _self->x2 = x2;
  return &_self->_base;
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_control2(kk_function_t clause0, kk_context_t* _ctx) { /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_control2_fun10769(clause0, _ctx), _ctx);
}
...
// lift anonymous function
struct kk_std_core_hnd_under1_fun10808__t {
  struct kk_function_s _base;
...
static inline kk_function_t kk_std_core_hnd_new_under1_fun10808(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under1_fun10808__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under1_fun10808__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under1_fun10808, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under1(kk_std_core_hnd__ev ev, kk_function_t op, kk_box_t x, kk_context_t* _ctx) { /* forall<a,b,e,c> (ev : ev<c>, op : (a) -> e b, x : a) -> e b */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x10807 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<8753>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x10807, _ctx); /*std/core/hnd/evv<_8698>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), op, (op, x, _ctx)); /*8751*/;
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    kk_evv_drop(w0, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under1_fun10808(ev, _ctx), _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun10810__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun10810(kk_function_t _fself, kk_function_t cont, kk_box_t res, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun10810(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun10810__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun10810__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun10810, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
// lift anonymous function
struct kk_std_core_hnd_under0_fun10812__t {
  struct kk_function_s _base;
  kk_std_core_hnd__ev ev;
};
extern kk_box_t kk_std_core_hnd_under0_fun10812(kk_function_t _fself, kk_function_t cont0, kk_box_t res0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_hnd_new_under0_fun10812(kk_std_core_hnd__ev ev, kk_context_t* _ctx) {
  struct kk_std_core_hnd_under0_fun10812__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_under0_fun10812__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_under0_fun10812, kk_context());
  _self->ev = ev;
  return &_self->_base;
}
...
static inline kk_box_t kk_std_core_hnd_under0(kk_std_core_hnd__ev ev, kk_function_t op, kk_context_t* _ctx) { /* forall<a,e,b> (ev : ev<b>, op : () -> e a) -> e a */ 
  kk_evv_t w0;
  kk_std_core_hnd__ev _x10809 = kk_std_core_hnd__ev_dup(ev); /*std/core/hnd/ev<8806>*/
  w0 = kk_std_core_hnd_evv_swap_with(_x10809, _ctx); /*std/core/hnd/evv<_8758>*/
  kk_box_t y = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), op, (op, _ctx)); /*8804*/;
  kk_unit_t __ = kk_Unit;
  kk_evv_set(w0,kk_context());
  if (kk_yielding(kk_context())) {
    kk_box_drop(y, _ctx);
    return kk_std_core_hnd_yield_cont(kk_std_core_hnd_new_under0_fun10810(ev, _ctx), _ctx);
  }
  {
    kk_std_core_hnd__ev_dropn(ev, ((int32_t)KI32(3)), _ctx);
    return y;
...
// lift anonymous function
struct kk_std_core_hnd_clause_tail2_fun10825__t {
  struct kk_function_s _base;
  kk_function_t op;
};
...
static inline kk_function_t kk_std_core_hnd_new_clause_tail2_fun10825(kk_function_t op, kk_context_t* _ctx) {
  struct kk_std_core_hnd_clause_tail2_fun10825__t* _self = kk_function_alloc_as(struct kk_std_core_hnd_clause_tail2_fun10825__t, 2, _ctx);
  _self->_base.fun = kk_cfun_ptr_box(&kk_std_core_hnd_clause_tail2_fun10825, kk_context());
  _self->op = op;
  return &_self->_base;
}
...
static inline kk_std_core_hnd__clause2 kk_std_core_hnd_clause_tail2(kk_function_t op, kk_context_t* _ctx) { /* forall<e,a,b,c,d,a1> (op : (b, c) -> e d) -> clause2<b,c,d,a1,e,a> */ 
  return kk_std_core_hnd__new_Clause2(kk_std_core_hnd_new_clause_tail2_fun10825(op, _ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_finally(kk_function_t fin, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (fin : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x10840 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*9629*/
  return kk_std_core_hnd_finally_prompt(fin, _x10840, _ctx);
}
...
static inline kk_box_t kk_std_core_hnd_local_var(kk_box_t init, kk_function_t action, kk_context_t* _ctx) { /* forall<a,b,e,h> (init : a, action : (l : local-var<h,a>) -> <local<h>|e> b) -> <local<h>|e> b */ 
  ...
  kk_box_t res;
  kk_ref_t _x10857 = kk_ref_dup(loc); /*local-var<9998,9995>*/
  res = kk_function_call(kk_box_t, (kk_function_t, kk_ref_t, kk_context_t*), action, (action, _x10857, _ctx)); /*9996*/
...
static inline kk_std_core_types__either kk_std_core_hnd_unsafe_try_finalize(kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (action : () -> e a) -> e either<yield-info,a> */ 
  kk_box_t _x10870 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx)); /*10226*/
  return kk_std_core_hnd_try_finalize_prompt(_x10870, _ctx);
}
